        ...
        <div className="row">
          <div className={`col-12 col-md-12 col-lg-6 `}>
            <div className={`${style.car}`}>
              ...
              <p className="fw-bold fs-5 m-0 ms-1 me-1">
                {t("Your order is on the way")}
              </p>
            </div>
            {cart.length > 0 ? (
                ...
                <div key={index}>
                  <div className={`${style.card}`}>
                    <div className={style.conImg}>
                      <img
                        className="w-100"
                        src={`https://perfect.somee.com/${product[0].Imageproudect}`}
                    ...
                    <div>
                      {product[0].Pricesale ? (
                        <div className="d-flex align-items-center justify-content-start fs-5">
                          ...
                          <p className="text-danger">
                            : EGP {product[0].Pricesale}
                          </p>
                        </div>
                      ) : (
                        <p className="fs-5 fw-bold m-0">
                          EGP: {product[0].PriceProduct}
                        </p>
                      )}
                      ...
                      <div className="d-flex align-items-center justify-content-start">
                        <p>{t("Color:")}</p>
                        <div
                          className={style.color_span}
                          style={{ backgroundColor: product[1].color }}
                        ></div>
                      </div>
                    </div>
                  </div>
            ...
            <div className={style.button_tetel}>
              <div className="d-flex justify-content-center align-items-center border">
                <h5 className="text-black-50">{t("Order Total:")}</h5>
          ...
          <div className="col-12 col-md-12 col-lg-6">
            <div className="d-flex justify-content-center align-items-center mt-2">
              <h5 className="m-0 me-1">{t("Order is Done")}</h5>
              <FontAwesomeIcon
                icon={faCircleCheck}
                className="fs-4 text-success"
              />
            </div>
            <h6 className="mt-1 text-black-50">
              {t(
                "Your order has been confirmed successfully! We will contact you within 24 hours."
              )}
            </h6>
            <img className={style.img} src={copletOrder} alt="" />
            <h6 className="text-black-50 mb-2">
              {t(
                "We are always striving to improve our services. We would like to hear your opinion about your experience with us here ="
              )}{" "}
              <a href="/contactus">{t("Here")}</a>
            </h6>
          </div>
        </div>
      </div>
